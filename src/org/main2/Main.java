...
public static void main(String[] args) {
	...
	// test data set
	int [] nums= {1,2,3};
	//1. com. utll. CollectionStack
	// 	 add - 새로운 숫자 추가 무조건 0번 인데스 추가(앞에다가 넣어) 입력받아 
	// 	 remove 호출- 0번 인덱스 삭제
	...
	//	 3. com. utll. CollectionStionSet
		//  add - 새로운 숫자 추가 무조건 마지막에 추가  (단, 중복되지 않는 숫자만 추가	
